	...
	<script type="text/javascript" src="../assets/js/NSX.js"></script>
				...
				<!-- <div class="infor-main"> -->
					...
					<div class="main-content">
						...
						<a href="index.php?controller=hangcu&action=create" style="display: inline-block;margin-bottom: 1%;margin-left: 1%;">
						    ...
						    <tr>
						    	<!-- id -->
                    		  	...
                    		  	<td style="text-align: center;">
                        			<?php if($value->photo !="" && file_exists("../assets/upload/hangcu/".$value->photo)):  ?>
                        			<img src="../assets/upload/hangcu/<?php echo $value->photo; ?>" alt="" style="width: 100px;">
                    				<?php endif; ?>
						      ...
						      <td style="display: flex;">
						      	...
						      	<div class="fix">
						      	<a href="index.php?controller=hangcu&action=update&id=<?php echo $value->id ?>">
						      ...
						      <div style="width: 10%"></div>
						      	<div class="xoa">
						      		<a href="index.php?controller=hangcu&action=delete&id=<?php echo $value->id ?>">
						...
						<div class="row">
							...
							<div class="col-md-8">
			            		<ul class="pagination">
			            			...
			            			<li><a href="index.php?controller=hangcu&p=<?php echo $j; ?>"> <?php echo $j; ?> </a></li>
			            		<?php endfor; ?>
			            	</ul>
