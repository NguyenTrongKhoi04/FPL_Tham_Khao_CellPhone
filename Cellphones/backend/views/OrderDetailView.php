	...
	<script type="text/javascript" src="../assets/js/NSX.js"></script>
 				...
 				<div class="title-main">
					...
					<div style="width: 100%;text-align: right;">
			            ...
			            <a href="index.php?controller=order&action=exportExcel&idExport=<?php echo $idExport ?>" class="btn btn-warning" style="margin: 1.5rem;">Export Excel</a>

			            <a href="index.php?controller=order&action=seeBill&idExport=<?php echo $idExport ?>" class="btn btn-info" style="margin: 1.5rem;">Xuất hóa đơn</a>
			        </div>
					<!-- /Export excel -->
