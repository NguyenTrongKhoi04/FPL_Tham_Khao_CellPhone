	...
	<script type="text/javascript" src="../assets/js/NSX.js"></script>
				...
				<!-- <div class="infor-main"> -->
					...
					<div class="main-content">
						...
						<a href="index.php?controller=phukien&action=create" style="display: inline-block;margin-bottom: 1%;margin-left: 1%;">
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td style="display: flex;">
						      	...
						      	<div class="fix">
						      	<a href="index.php?controller=phukien&action=update&id=<?php echo $value->id ?>">
						      ...
						      <div style="width: 10%"></div>
						      	<div class="xoa">
						      		<a href="index.php?controller=phukien&action=delete&id=<?php echo $value->id ?>">
						    ...
						    <tr>
						      ...
						      <td style="display: flex;">
						      	...
						      	<div class="fix">
						      	<a href="index.php?controller=phukien&action=update&id=<?php echo $rows->id ?>">
						      			<button type="button" class="btn btn-success fix" >	
						      				<i class="fas fa-edit"></i>
						      			</button>
						      	</a>
						      ...
						      <div style="width: 10%"></div>
						      	<div class="xoa">
						      		<a href="index.php?controller=phukien&action=delete&id=<?php echo $rows->id ?>">
						      			<button type="button" class="btn btn-danger delete">
						      				<i class="far fa-trash-alt"></i>
						      			</button>
						      		</a>
						...
						<div class="row">
							...
							<div class="col-md-8">
			            		<ul class="pagination">
			            			...
			            			<li><a href="index.php?controller=phukien&p=<?php echo $j; ?>"> <?php echo $j; ?> </a></li>
			            		<?php endfor; ?>
			            	</ul>
