						  ...
						  <tbody>
						    ...
						    <tr>
			                    ...
			                    <td style="text-align: center;">
			                     ...
			                     <td style="text-align: center;">
			                        <a href="index.php?controller=staff&action=detail&id=<?php echo $value->id; ?>" class="badge badge-success">Chi tiết</a>
			                        <?php if($value->status == 0): ?>
			                            <a href="index.php?controller=staff&action=delivery&id=<?php echo $value->id; ?>" class="badge badge-primary">Giao hàng</a>
			                         <?php endif; ?>
			                     </td>
			                </tr>
                	<?php endforeach; ?>
						...
						<div class="row">
							...
							<div class="col-md-8">
			            		<ul class="pagination">
			            			...
			            			<li><a href="index.php?controller=staff&p=<?php echo $j; ?>"> <?php echo $j; ?> </a></li>
			            		<?php endfor; ?>
			            	</ul>
