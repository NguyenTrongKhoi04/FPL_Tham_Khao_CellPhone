			...
			<div class="col-md-4 gia">
				...
				<div class="row dong4">
					...
					<div class="col-6" style="text-align: right;">
						<p>
							<a href="index.php?controller=phonedetail&action=checkOut&category=laptop&id=<?php echo $value->id ?>&star=1" class="badge badge-info">Đánh giá</a>
							&nbsp;
							<span class="badge badge-warning"><?php echo $this->modelGetStar($value->id,1); ?> votes</span>
						</p>
						<p>
							<a href="index.php?controller=phonedetail&action=checkOut&category=laptop&id=<?php echo $value->id ?>&star=2" class="badge badge-info">Đánh giá</a>
							&nbsp;
							<span class="badge badge-warning"><?php echo $this->modelGetStar($value->id,2); ?> votes</span>
						</p>
						<p>
							<a href="index.php?controller=phonedetail&action=checkOut&category=laptop&id=<?php echo $value->id ?>&star=3" class="badge badge-info">Đánh giá</a>
							&nbsp;
							<span class="badge badge-warning"><?php echo $this->modelGetStar($value->id,3); ?> votes</span>
						</p>
						<p>
							<a href="index.php?controller=phonedetail&action=checkOut&category=laptop&id=<?php echo $value->id ?>&star=4" class="badge badge-info">Đánh giá</a>
							&nbsp;
							<span class="badge badge-warning"><?php echo $this->modelGetStar($value->id,4); ?> votes</span>
						</p>
						<p>
							<a href="index.php?controller=phonedetail&action=checkOut&category=laptop&id=<?php echo $value->id ?>&star=5" class="badge badge-info">Đánh giá</a>
							&nbsp;
