...
<div class="col-md-10 right">
	...
	<div class="row bonus">
		<div class="col-md-8 gia">
			...
			<ul style="display: flex; margin-left: 5px;">
				...
				<?php $category=isset($_GET["category"])?$_GET["category"]:"dienthoai" ?>
				<li>
	...
	<div class="danhmuc">
		<ul class="col-md-12">
			<?php 
				$product=$this->modelHotSp();
			 ?>
			 <?php 
					foreach ($product as $value):  ?>
			<li>
				<?php if(isset($value->photo)): ?>
				<a href="index.php?controller=phonedetail&action=amthanhdetail&id=<?php echo $value->id; ?>"><img src="../assets/upload/phone/<?php echo $value->photo;?>" alt="" style="width: 100%;"></a>
			<?php endif; ?>
				...
				<div class="tensp" style="height: 40px;padding-left: 5px;">
					<a href="index.php?controller=phonedetail&action=amthanhdetail&id=<?php echo $value->id; ?>" style="font-size: 13px;font-weight: 700;"><?php echo $value->name; ?></a>
				</div>
