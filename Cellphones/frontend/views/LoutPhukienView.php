	...
	<div class="danhmuc">
		<ul class="col-md-12">
			...
			<li>
				...
				<a href="index.php?controller=phonedetail&action=phukiendetail&id=<?php echo $value->id; ?>"><img src="../assets/upload/phone/<?php echo $value->photo;?>" alt="" style="width: 100%;"></a>
			<?php endif; ?>
				...
				<div class="tensp" style="height: 40px;padding-left: 5px;">
					<a href="index.php?controller=phonedetail&action=phukiendetail&id=<?php echo $value->id; ?>" style="font-size: 13px;font-weight: 700;"><?php echo $value->name; ?></a>
				</div>
