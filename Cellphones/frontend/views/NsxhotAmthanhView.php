...
<div class="col-md-10 right">
					<h3 style="font-weight: bold;">Apple</h3>
					<div class="title">
						<ul>
							<li><a href="#">Iphone11</a></li>
							<li><a href="#">Iphone12</a></li>
							<li style="width: 15%"><a href="#">IphoneSE 2020</a></li>
							<li><a href="#">Iphone8</a></li>
							<li><a href="#">IphoneXR</a></li>
						</ul>
					</div>
					...
					<div class="danhmuc">
						<ul class="col-md-12">
							<?php 
								$id_nsx=isset($_GET['id_nsx'])?$_GET['id_nsx']:"";
								$product=$this->modelHotSpNsxAmthanh($id_nsx);
							 ?>
							 <?php 
							...
							<?php endif; ?>
								...
								<div class="tensp" style="height: 40px;padding-left: 5px;">
									<a href="index.php?controller=phonedetail&id=<?php echo $value->id; ?>" style="font-size: 13px;font-weight: 700;"><?php echo $value->name; ?></a>
								</div>
